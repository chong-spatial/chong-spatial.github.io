...
$( "#support-slider" ).slider({
  ...
  values: [Math.floor(suppMinMax[0] * 100), suppMinMax[1] * 100],
  ...
  slide: function( event, ui ) {
    ...
    parsets.orderDimension([{"name": "Survived", "idx": -1}].concat(newColumns), dimCates);
...
$('input[name=sortDim]:radio').change(function(){  
  ...
  var newColumns = ruleGrid.columnOrder().map(function(c){ return {name: c} });
  newColumns.forEach(function(c, i){ c.idx = i; });
  parsets.orderDimension([{"name": "Survived", "idx": -1}].concat(newColumns));
...
function categoriesOdered (by){
  // parsets.orderDimension([{"name":"Survived","categories":[{"name":"Yes"},{"name":"No"}]},{"name":"Age","categories":[{"name":"Child"},{"name":"Adult"}]},{"name":"Sex","categories":[{"name":"Female"},{"name":"Male"}]}, {"name":"Survived","categories":[{"name":"1st"},{"name":"Crew"},{"name":"2nd"},{"name":"3rd"}]}])
...
function ruleClick(d) {
  ...
  forParsetDims.forEach(function(c, i){ c.idx = i; });
  parsets.orderDimension([{"name": "Survived", "idx": -1}].concat(forParsetDims));
