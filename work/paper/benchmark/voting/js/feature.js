...
var c = function(cls, supp){ return cls == "R" ? colorSupportGreen(supp) : colorSupportRed(supp)};
...
d3.ruleGrid = function() {
  ...
  function dataProcess(newData){
    ...
    orderFunctions = {
        ...
        yIndex: newData.filter(function(d){ return d.cls == 'R'}).sort(function(a, b) { return d3.ascending(a.id, b.id)}).concat(newData.filter(function(d){ return d.cls == 'D'}).sort(function(a, b) { return d3.ascending(a.id, b.id)}) ).map(function(d){ return d.id }),
        ...
        itemNameInCls: function(dimName){ 
          ...
          var rulesLabYes = newData.filter(function(d){ return d.cls == 'R'}),
              rulesLabNo = newData.filter(function(d){ return d.cls == 'D'});
        ...
        ruleSuppInCls: newData.filter(function(d){ return d.cls == 'R'}).sort(function(a, b) { return d3.descending(a.m[0], b.m[0])}).concat(newData.filter(function(d){ return d.cls == 'D'}).sort(function(a, b) { return d3.descending(a.m[0], b.m[0])}) ).map(function(d){ return d.id }),
        
        ruleConfInCls: newData.filter(function(d){ return d.cls == 'D'}).sort(function(a, b) { return d3.descending(a.m[1], b.m[1])}).concat(newData.filter(function(d){ return d.cls == 'D'}).sort(function(a, b) { return d3.descending(a.m[1], b.m[1])}) ).map(function(d){ return d.id }),
  ...
  function similarityOrder(by) {
    ...
    if(by == 'mixCloseness') {
      ...
      for(var i = 0; i < matrix.length; i++){
        var row = matrix[i];
        if(row.find(function(a){ return a.z !=0 }).rule.cls == 'R'){
            for(var j = 0; j < row.length; j++){
            var cell = row[j];
            binaryMatrix[j][i] = cell.z == 0 ? 0 : 1;
          }
      ...
      for(var i = 0; i < matrix.length; i++){
        var row = matrix[i];
        if(row.find(function(a){ return a.z !=0 }).rule.cls == 'D'){
            for(var j = 0; j < row.length; j++){
            var cell = row[j];
            binaryMatrix[j][i] = cell.z == 0 ? 0 : 1;
          }
  ...
  exports.redraw = function(){    
    ...
    colorSupportGreen.domain(d3.extent(rData.filter(function(d){return d.cls === 'R'}), function(d){ return d.m[0]}))
    colorSupportRed.domain(d3.extent(rData.filter(function(d){return d.cls === 'D'}), function(d){ return d.m[0]}))
    ...
    rowEnter.append('rect')
      ...
      .attr("height", y.rangeBand())   
        .classed('rowBgGreen', function(d){ 
          return d.find(function(a){ return a.z !=0 }).rule.cls === 'R'})
        .classed('rowBgRed', function(d){ return d.find(function(a){ return a.z !=0 }).rule.cls === 'D'})
        //.style('display', 'none')
