...
d3.ruleGrid = function() {
  ...
  exports.redraw = function(){    
    ...
    colorSupportGreen.domain(d3.extent(rData.filter(function(d){return d.cls === 'Yes'}), function(d){ return d.m[0]}))
    colorSupportRed.domain(d3.extent(rData.filter(function(d){return d.cls === 'No'}), function(d){ return d.m[0]}))
