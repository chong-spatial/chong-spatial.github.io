// src from https://github.com/meandavejustice/canvas-pixel-color/blob/master/index.js
...
function CanvasCrossTable(canvasId, options) {
    ...
    this.rules_ids = this.colData.map(function(r) {
        return r.cls + "_" + r.id
    });



    this.obsIdx = this.rowData.map(function(o) {
        return o.idx
    });
