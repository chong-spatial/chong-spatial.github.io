     ...
     _render: function() {
       ...
       if(this.svg_type == 'path'){
        ...
        featureg.each(function(d){
          ...
          var vorSeeds = d3.range(validDimensions.length).map(function(d) {
            return [x + Math.random() , y + Math.random() ];
          });

          

          // [["Other_Biom",14], ["Wood",3035], ["Hydro",12535]]
          function testGen(validEngergyAry){
          ...
          var vorPath = d3.select(this).append('g').selectAll('.voronoi')
            ...
            .attr('title', function(d){ 
              ...
              var curEnergyNameValue = validEngergyAry[vorPathData0Area.indexOf(area)]; 
