  ...
  function(
    ...
    return GraphicsLayer.createSubclass({
     ...
     _setMap: function(map, surface) {
       ...
       this.allAttributes = ['name', 'Hydro', 'Solar', 'Wind', 'Landfill_G', 
       ...
       if(this.svg_type == 'path'){
        ...
        featureg.each(function(d){
          ...
          */
            ...
            .call(d3.helper.tooltipOrdinal(forTooltip, self.allOriNormOrdAttr, d.properties.name))
         ...
         loop();
          ...
          function generateBestVoronoiVertices(){
            ...
            function montecarlo(){
              ...
              return (dx * dx + dy * dy < stateArea/100) ? vCells : false; //stateArea/1000
              // equal-sized
